...
public class BattleExtensions {
     ...
     * @param enemy enemy of the map
     * @param enemies the enemies on the map
     * set the HP of the enemies to the original stat
     */
    public static void reset(Optional<Entity> boss, Entity enemy, ArrayList<Entity>... enemies){
        try {
    ...
    public static void searchEnemy(Entity enemy){
        if (enemy instanceof Crystal){
            enemy.setHP(70);
        } else if (enemy instanceof Infant){
            enemy.setHP(80);
