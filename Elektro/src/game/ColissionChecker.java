...
public class ColissionChecker {
    ...
    public int checkEntity(Entity entity, Entity[] targets){
        ...
        for (int i = 0; i < targets.length; i++){
            if(targets[i]!=null){
                ...
                entity.solidArea.x = entity.solidAreaDefaultX;
                entity.solidArea.y = entity.solidAreaDefaultY;
                targets[i].solidArea.x = entity.solidAreaDefaultX;
                targets[i].solidArea.y = entity.solidAreaDefaultY;
            }
        }
        return index;
    }
    public void checkPlayer(Entity entity){
        ...
        entity.solidArea.x = entity.solidAreaDefaultX;
        entity.solidArea.y = entity.solidAreaDefaultY;
        gamePanel.player.solidArea.x = entity.solidAreaDefaultX;
        gamePanel.player.solidArea.y = entity.solidAreaDefaultY;
    }
}
