...
public abstract class Level {
    ...
    public void loadMaps(){
        ...
        for(Map map: maps){
            ...
            map.loadMap();
            gamePanel.setTileManager(map.getTileManager());
        }
    }
    /**
     * Play the level.
    ...
    public void play() {
        ...
        gamePanel.setCurrentMap(this.maps.getFirst());
        gamePanel.getCurrentMap().loadMap();
        gamePanel.getPlayer().updateSpawnPosition();
        gamePanel.setTileManager(gamePanel.getCurrentMap().getTileManager());
     ...
     */
    public boolean isFinishedLevel(){return finishedLevel;}
    /**
     * Set the next level status.
     * @param finishedLevel whether the player can go to the next level or not.
     */
    public void setFinishedLevel(boolean finishedLevel) {this.finishedLevel = finishedLevel;}
}
