...
public class SpecialAttackAction implements ActionListener{
    private Battle bt;
     ...
     */
    public SpecialAttackAction(Battle bt, JProgressBar playerHP, JProgressBar enemyHP, JLabel status ,JDialog options, JFrame actualFrame, JLabel enemyStatus) {
        this.bt = bt;
    ...
    /**
     * Handles the action event triggered by user interaction. This method initiates a fight with a special attack,
