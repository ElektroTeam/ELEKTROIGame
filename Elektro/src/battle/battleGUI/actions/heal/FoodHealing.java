 ...
 * @see ItemHealing
 */
public class FoodHealing extends ItemHealing {
    /**
     ...
     * @param button Food button we want to update
     * @param status Message in battle GUI
     */
    public FoodHealing(Battle bt, JProgressBar playerHP, JProgressBar enemyHP, JDialog optionDialog, JButton button, JLabel status) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String message = "Food: "+ bt.cantFood();
