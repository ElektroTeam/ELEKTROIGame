 ...
 * @see ItemHealing
 */
public class BandageHealing extends ItemHealing{
     ...
     * @param button Bandage button we want to update
     * @param status Message in battle GUI
     */
    public BandageHealing(Battle bt, JProgressBar playerHP, JProgressBar enemyHP, JDialog optionDialog, JButton button, JLabel status) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String message = "Bandage: "+ bt.cantBandage();
